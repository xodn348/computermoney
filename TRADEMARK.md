...
- Use the name to refer to this project truthfully — in articles, talks,
  package metadata, or statements like "built on computermoney".
- Distribute unmodified builds of this software under the name.
